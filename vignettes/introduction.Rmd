...
[^1]: This is based on the data created in the R code file "panel\_demonstration\_v5\_shared.R".
...
However, changing the `cluster` specification of course does. **Why the Standard Errors allow for so many more indicators to be selected, however, needs to be investigated further.**
