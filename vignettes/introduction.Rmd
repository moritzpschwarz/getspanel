...
```{r, eval = !file.exists("introduction_files/fixest_example.RData") & R.version$major > 3}
...
```{r, eval = !file.exists("introduction_files/fixest_example.RData")& R.version$major > 3, echo=FALSE}
...
```{r, eval = !file.exists("introduction_files/fixest_example_cluster.RData") & R.version$major > 3}
...
```{r, eval = !file.exists("introduction_files/fixest_example_cluster.RData") & R.version$major > 3, echo=FALSE}
