...
```{r, echo = FALSE}
if(!dir.exists("introduction_files")){dir.create("introduction_files")}
```


```{r, eval = !file.exists("introduction_files/is_lm.RData")}
...
```{r, eval = !file.exists("introduction_files/is_lm.RData"), echo=FALSE}
save(is_lm, file = "introduction_files/is_lm.RData")
```

```{r, eval = file.exists("introduction_files/is_lm.RData"), echo = FALSE}
load(file = "introduction_files/is_lm.RData")
```


Using the traditional method

```{r, eval = !file.exists("introduction_files/is_gets.RData")}
...
```{r, eval = !file.exists("introduction_files/is_gets.RData"), echo=FALSE}
save(is_gets, file = "introduction_files/is_gets.RData")
```

```{r, eval = file.exists("introduction_files/is_gets.RData"), echo = FALSE}
load(file = "introduction_files/is_gets.RData")
```
...
```{r, eval = !file.exists("introduction_files/iis_example.RData")}
...
```{r, eval = !file.exists("introduction_files/iis_example.RData"), echo=FALSE}
save(iis_example, file = "introduction_files/iis_example.RData")
```

```{r, eval = file.exists("introduction_files/iis_example.RData"), echo = FALSE}
load(file = "introduction_files/iis_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/jsis_example.RData")}
...
```{r, eval = !file.exists("introduction_files/jsis_example.RData"), echo=FALSE}
save(jsis_example, file = "introduction_files/jsis_example.RData")
```

```{r, eval = file.exists("introduction_files/jsis_example.RData"), echo = FALSE}
load(file = "introduction_files/jsis_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/csis_example.RData")}
...
```{r, eval = !file.exists("introduction_files/csis_example.RData"), echo=FALSE}
save(csis_example, file = "introduction_files/csis_example.RData")
```

```{r, eval = file.exists("introduction_files/csis_example.RData"), echo = FALSE}
load(file = "introduction_files/csis_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/csis_example2.RData")}
...
```{r, eval = !file.exists("introduction_files/csis_example2.RData"), echo=FALSE}
save(csis_example2, file = "introduction_files/csis_example2.RData")
```

```{r, eval = file.exists("introduction_files/csis_example2.RData"), echo = FALSE}
load(file = "introduction_files/csis_example2.RData")
```
...
```{r, eval = !file.exists("introduction_files/fesis_example.RData")}
...
```{r, eval = !file.exists("introduction_files/fesis_example.RData"), echo=FALSE}
save(fesis_example, file = "introduction_files/fesis_example.RData")
```

```{r, eval = file.exists("introduction_files/fesis_example.RData"), echo = FALSE}
load(file = "introduction_files/fesis_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/fesis_example2.RData")}
...
```{r, eval = !file.exists("introduction_files/fesis_example2.RData"), echo=FALSE}
save(fesis_example2, file = "introduction_files/fesis_example2.RData")
```

```{r, eval = file.exists("introduction_files/fesis_example.RData"), echo = FALSE}
load(file = "introduction_files/fesis_example2.RData")
```
...
```{r, eval = !file.exists("introduction_files/cfesis_example.RData")}
...
```{r, eval = !file.exists("introduction_files/cfesis_example.RData"), echo=FALSE}
save(cfesis_example, file = "introduction_files/cfesis_example.RData")
```

```{r, eval = file.exists("introduction_files/cfesis_example.RData"), echo = FALSE}
load(file = "introduction_files/cfesis_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/fesis_ar1_example.RData")}
...
```{r, eval = !file.exists("introduction_files/fesis_ar1_example.RData"), echo=FALSE}
save(fesis_ar1_example, file = "introduction_files/fesis_ar1_example.RData")
```

```{r, eval = file.exists("introduction_files/fesis_ar1_example.RData"), echo = FALSE}
load(file = "introduction_files/fesis_ar1_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/fixest_example.RData") & R.version$major > 4}
...
```{r, eval = !file.exists("introduction_files/fixest_example.RData")& R.version$major > 4, echo=FALSE}
save(fixest_example, file = "introduction_files/fixest_example.RData")
```

```{r, eval = file.exists("introduction_files/fixest_example.RData")& R.version$major > 4, echo = FALSE}
load(file = "introduction_files/fixest_example.RData")
```
...
```{r, eval = !file.exists("introduction_files/fixest_example_cluster.RData") & R.version$major > 4}
...
```{r, eval = !file.exists("introduction_files/fixest_example_cluster.RData") & R.version$major > 4, echo=FALSE}
save(fixest_example_cluster, file = "introduction_files/fixest_example_cluster.RData")
```

```{r, eval = file.exists("introduction_files/fixest_example_cluster.RData") & R.version$major > 4, echo = FALSE}
load(file = "introduction_files/fixest_example_cluster.RData")
```
