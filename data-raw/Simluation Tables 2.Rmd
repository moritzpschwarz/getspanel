...
<!--         col.names = c("Sample","AR", "Outl. Prop.", "Level","p-value","# Regressors","$\lambda$","Rejection Freq.", "Euclidian Distance")) -> tab -->
...
cat(tab_boot_null, file = here("data-raw/text/v8/simulation_tables/boot_null.tex"))
...
```{r}
cat(table_list_boot_alt, file = here("data-raw/text/v8/simulation_tables/alternative_boot.tex"))
```
