...
for(est_version in c(0.05, 0.01,0.001)){
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist.pdf")), height=7, width=8)
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist_adapt.pdf")), height=7, width=8)
  par(mfrow=c(1,1))
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist_adapt.L1.pdf")), height=7, width=8)
  par(mfrow=c(1,1))
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist_sign.pdf")), height=5, width=11)
  par(mfrow=c(1,1))
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist_sign.adapt.pdf")), height=5, width=11)
  par(mfrow=c(1,1))
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"year_hist_sign.adapt.L1.pdf")), height=5, width=11)
  par(mfrow=c(1,1))
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"heat1.pdf")), height=10, width=8)
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"heat1_adapt.pdf")), height=10, width=8)
  ...
  #pdf("C:/Users/Felix/OneDrive/Documents/Projects/IS beta testing/application/adaptation damage/heat1_lag.pdf", height=10, width=8)
  pdf(here(paste0("data-raw/projections/out/",est_version,"heat1_adapt.L1.pdf")), height=10, width=8)
  ...
  # pdf(here(paste0("data-raw/projections/out/",est_version,"isat_adapt_impacts.pdf"), height=8, width=12)
  # par(mfrow=c(1,3))
  #
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"isat_adapt_impacts_adapt.pdf")), height=8, width=12)
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"isat_adapt_impacts_adapt.L1.pdf")), height=8, width=12)
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"coef_dist_eff.adapt.pdf")), height=9, width=12)
  ...
  #pdf("C:/Users/Felix/OneDrive/Documents/Projects/IS beta testing/application/adaptation damage/coef_dist_eff_v1.pdf", height=9, width=12)
  pdf(here(paste0("data-raw/projections/out/",est_version,"coef_dist_eff.adapt.L1.pdf")), height=9, width=12)
  ...
  #pdf("C:/Users/Felix/OneDrive/Documents/Projects/IS beta testing/application/adaptation damage/coef_v2.pdf", height=5, width=10)
  pdf(here(paste0("data-raw/projections/out/",est_version,"coef.adapt.L1.pdf")), height=5, width=10)
  ...
  pdf(here(paste0("data-raw/projections/out/",est_version,"eff.adapt.v2.pdf")), height=8, width=12)
  ...
  #pdf("C:/Users/Felix/OneDrive/Documents/Projects/IS beta testing/application/adaptation damage/eff_v1.pdf", height=8, width=12)
  pdf(here(paste0("data-raw/projections/out/",est_version,"eff.adapt.L1.v2.pdf")), height=8, width=12)
