...
# varying significance level of t.pval
# varying block size
# varying number of treated countries/time periods
...
base_time <- 1900
k = 6  # number of units (countries)
n_time = 50 # number of time periods

sigma = 0.5 # this is the variation of the noise in the DGP
fe_sigma = 5 # this is the variation of the fixed effects
...
# this is the IDs which are treated (of K)
treated_step <- c(3,5)
treated_trend <- c(2)
